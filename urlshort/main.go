...
func main() {
	...
	http.HandleFunc("/shorten", func(w http.ResponseWriter, r *http.Request) {
		if r.Method == "POST" {
			...
			fullURL := "http://164.92.98.66/s/" + shortURL  // Replace "http://example.com" with your actual domain

        // Send a clickable link as the response
        fmt.Fprintf(w, "Shortened URL: <a href=\"%s\">%s</a>", fullURL, fullURL)
		}
	})
